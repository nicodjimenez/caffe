...
$UTIL/convert_imageset.bin / $USE_CAFFE/listfile_test.txt omni-test-leveldb 0 0

echo "Creating leveldb for training set..."
$UTIL/convert_imageset.bin / $USE_CAFFE/listfile_train.txt omni-train-leveldb 0 1
